...
//free function of best fit strategy
void bf_free(void * ptr){
  ff_free(ptr);
}
//this function is to get the size of block with largest size in freeList
...
//this function is to get total available size in freeList
